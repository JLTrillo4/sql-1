...
-- Tu respuesta aquí
-- SELECT * FROM usuarios_lenguajes WHERE lenguaje = "Java" < 25;
...
-- Tu respuesta aquí
-- SELECT COUNT(*) lenguaje_python FROM usuarios_lenguajes WHERE lenguaje="python"
...
-- Tu respuesta aquí
-- SELECT * FROM usuarios_lenguajes WHERE edad BETWEEN 25 AND 35 lenguaje IS NOT NULL AND lenguaje !='';
...
-- Tu respuesta aquí
-- SELECT nombre, COUNT(*) AS cantidad FROM usuarios_lenguajes GROUP BY nombre;
...
-- Tu respuesta aquí
-- LECT edad FROM usuarios_lenguajes GROUP BY edad HAVING COUNT(*) > 1;
...
-- Tu respuesta aquí
-- SELECT DISTINCT email FROM usuarios_lenguajes;
...
-- Tu respuesta aquí
-- SELECT COUNT(DISTINCT nombre) FROM usuarios_lenguajes WHERE edad BETWEEN 20 AND 25;
...
-- Tu respuesta aquí
-- SELECT nombre, edad - (SELECT AVG(edad) FROM usuarios_lenguajes) AS diferencia FROM usuarios_lenguajes;
